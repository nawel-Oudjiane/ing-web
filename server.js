...
// Routes
app.use('/api/auth', require('./routes/auth.routes'));// pour importer les routes auth
...
app.use('/api/stats', require('./routes/stats.routes'));// pour importer les routes stats

const reviewsRoutes = require('./routes/reviews.routes');
app.use('/api/reviews', reviewsRoutes);// pour importer les routes reviews
